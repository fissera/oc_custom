			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
					<ul class="nav nav-tabs">
						...
						<?php if (isset($tab_bundle_data)): ?>
							<li><a href="#tab-bundle-data" data-toggle="tab"><?php echo $tab_bundle_data; ?></a></li>
						<?php endif ?>
					...
					<div class="tab-content">
						...
						<?php if (isset($tab_bundle_data)): ?>
						<div class="tab-pane" id="tab-bundle-data">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody id="bundle-rows"></div>
									<tfoot>
										<tr>
											<td></td>
											<td><input type="text" onkeyup="trigAuto($(this), 'name');" value="" class="form-control" autocomplete="off"></td>
											<td><input type="text" onkeyup="trigAuto($(this), 'name');" value="" class="form-control" autocomplete="off"></td>
											<td></td>
											<td></td>
											<td></td>
						...
						function trigAuto(theInput, theFilter) {
							theInput.autocomplete({
								...
								'select': function(item) {
									theInput.val('');
									$('#bundle-row-child-' + item['value']).remove();

									html  = '<tr id="bundle-row-child-' + item['value'] + '">';
									...
									html += '    <input type="text" name="bundle_child[' + item['value'] + '][child_sort_order]" value="" class="form-control" />';
									html += '  </td>';
									html += '  <td class="text-left">';
									html += '    <button type="button" onclick="$(this).tooltip(\'destroy\');$(\'#bundle-row-child-' + item['value'] + '\').remove();" data-toggle="tooltip" title="Remove" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>';
									html += '  </td>';
									html += '</tr>';

									$('#bundle-rows').append(html);
								}
							});
						}
						//--></script>
